...
filename = './digits/0.png'
max_batch_size = 1
onnx_model_path = 'mnist_model_10.onnx'
...
t1 = time.time()
trt_outputs = do_inference(context, byindings=bindings, inputs=inputs, outputs=outputs, stream=stream) # numpy data
t2 = time.time()
